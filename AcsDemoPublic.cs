...
namespace ControlEntradaSalida
{
    ...
    public class AcsDemoPublic
    {
        ...
        public struct STRU_DEVICE_INFO
        {
            ...
            [MarshalAsAttribute(UnmanagedType.ByValTStr, SizeConst = HCNetSDK.NAME_LEN)]
            ...
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = HCNetSDK.MAX_AUDIO_V40)]
            ...
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = HCNetSDK.MAX_CHANNUM_V40, ArraySubType = UnmanagedType.Struct)]
            public STRU_CHANNEL_INFO[] pStruChanInfo; //channel structure
            public HCNetSDK.NET_DVR_IPPARACFG_V40[] pStruIPParaCfgV40;    //IP channel parameters
            public HCNetSDK.NET_DVR_IPALARMINCFG struAlarmInCfg;
            public HCNetSDK.NET_DVR_IPALARMINCFG_V40 pStruIPAlarmInCfgV40;  // IP alarm In parameters
            public HCNetSDK.NET_DVR_IPALARMOUTCFG_V40 pStruIPAlarmOutCfgV40; // IP alarm Out parameters
            public HCNetSDK.NET_DVR_IPALARMOUTCFG struAlarmOutCfg;
            public IntPtr pNext;
            ...
            public int iDoorNum;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 3 * HCNetSDK.MAX_DOOR_NUM_256, ArraySubType = UnmanagedType.I1)]
            public int[] iDoorStatus;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = HCNetSDK.MAX_DOOR_NUM_256, ArraySubType = UnmanagedType.ByValTStr)]
            ...
            public void Init()
            {
                ...
                iDeviceChanNum = -1;
                iDoorNum = -1;
                iDoorStatus = new int[3 * HCNetSDK.MAX_DOOR_NUM_256];
                sDoorName = new string[HCNetSDK.MAX_DOOR_NUM_256];
                iStartChan = 0;
                iDeviceType = 0;
                iDiskNum = 0;
                lDevicePort = 8000;
        ...
        public static bool CheckState(HCNetSDK.NET_DVR_DATE struItem)
        {
        ...
        public static bool CheckDate(HCNetSDK.NET_DVR_SIMPLE_DAYTIME struItem)
        {
