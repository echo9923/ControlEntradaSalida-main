...
namespace ControlEntradaSalida
{
    public class HCNetSDK_Facial
    {
        ...
        {
            public int dwSize;
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = HCNetSDK_Facial.ACS_CARD_NO_LEN)]
            ...
            public void init()
            {
                byCardNo = new byte[HCNetSDK_Facial.ACS_CARD_NO_LEN];
                byRes = new byte[124];
            }
        }
        ...
        {
            public int dwSize;
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = HCNetSDK_Facial.ACS_CARD_NO_LEN, ArraySubType = UnmanagedType.I1)]
            public byte[] byCardNo;
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = HCNetSDK_Facial.ERROR_MSG_LEN, ArraySubType = UnmanagedType.I1)]
            ...
            {
                byCardNo = new byte[HCNetSDK_Facial.ACS_CARD_NO_LEN];
                byErrorMsg = new byte[HCNetSDK_Facial.ERROR_MSG_LEN];
                byRes = new byte[131];
            }
        }
        ...
        public struct NET_DVR_FACE_PARAM_CTRL_CARDNO
        {
            ...
            public byte[] byRes1;
            public HCNetSDK_Facial.NET_DVR_FACE_PARAM_BYCARD struByCard;//按卡号的方式删除,读卡器暂时不写
        ...
        public struct NET_DVR_FACE_PARAM_BYCARD
        {
            ...
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = HCNetSDK_Facial.MAX_CARD_READER_NUM_512, ArraySubType = UnmanagedType.I1)]
            public byte[] byEnableCardReader;//人脸的读卡器信息，按数组表示
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = HCNetSDK_Facial.MAX_FACE_NUM, ArraySubType = UnmanagedType.I1)]
            ...
            {
                byCardNo = new byte[HCNetSDK_Facial.ACS_CARD_NO_LEN];
                byEnableCardReader = new byte[HCNetSDK_Facial.MAX_CARD_READER_NUM_512];
                byFaceID = new byte[HCNetSDK_Facial.MAX_FACE_NUM];
                byRes1 = new byte[42];
            }
        }
