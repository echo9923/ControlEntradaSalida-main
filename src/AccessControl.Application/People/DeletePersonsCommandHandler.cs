...
{
    public sealed class DeletePersonsCommandHandler
    {
        private readonly ILegacyPermissionOperations operations;

        public DeletePersonsCommandHandler(ILegacyPermissionOperations operations)
        {
        ...
        {
            return operations.DeletePersonsAsync(employeeIds, requestContext, cancellationToken);
        }
    }
}
