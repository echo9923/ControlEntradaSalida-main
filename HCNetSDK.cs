...
namespace ControlEntradaSalida
{
    public class HCNetSDK
    {
        ...
        public const int MINOR_CERTIFICATE_BLOCK_LIST = 0x71; // black list 
        ...
        public struct NET_DVR_CARD_CFG_V50
        {
            ...
            public void Init()
            {
                byDoorRight = new byte[HCNetSDK.MAX_DOOR_NUM_256];
                byBelongGroup = new byte[HCNetSDK.MAX_GROUP_NUM_128];
                wCardRightPlan = new ushort[HCNetSDK.MAX_DOOR_NUM_256 * HCNetSDK.MAX_CARD_RIGHT_PLAN_NUM];
                byCardNo = new byte[HCNetSDK.ACS_CARD_NO_LEN];
                byCardPassword = new byte[HCNetSDK.CARD_PASSWORD_LEN];
                byName = new byte[HCNetSDK.NAME_LEN];
                byRes2 = new byte[3];
                byLockCode = new byte[HCNetSDK.MAX_LOCK_CODE_LEN];
                byRoomCode = new byte[HCNetSDK.MAX_DOOR_CODE_LEN];
                byRes3 = new byte[83];
            }
        }
        ...
        public struct NET_DVR_FACE_PARAM_BYCARD
        {
            ...
            {
                byCardNo = new byte[HCNetSDK.ACS_CARD_NO_LEN];
                byEnableCardReader = new byte[HCNetSDK.MAX_CARD_READER_NUM_512];
                byFaceID = new byte[HCNetSDK.MAX_FACE_NUM];
                byRes1 = new byte[42];
            }
        }
        ...
        [DllImport(@".\HCNetSDK.dll")]
        public static extern bool NET_DVR_CaptureJPEGPicture(int lUserID, int lChannel, ref HCNetSDK.NET_DVR_JPEGPARA lpJpegPara, IntPtr sPicFileName);
        #endregion
